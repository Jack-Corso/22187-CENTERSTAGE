...
@TeleOp
public class WorldCentric extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        for (DcMotor m : hardwareMap.getAll(DcMotor.class)) m.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        // Declare our motors
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.a) hang.setPower(-1);
            else if (gamepad2.b) hang.setPower(1);
